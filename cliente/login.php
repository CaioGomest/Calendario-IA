...
<div class="login-estrutura">
  ...
  <div class="login-form">
    <form class="form-area" method="post" action="login">
      ...
      <a class="link esqueci-senha" href="recuperar"><?= traduz('link_esqueceu_senha') ?></a>
      ...
      <div class="link-central"><?= traduz('login_sem_conta') ?> <a class="link" href="cadastro"><?= traduz('link_criar_conta') ?></a></div>
    </form>
  </div>
