...
<title><?= htmlspecialchars(nomeApp()) ?> — Admin</title>
  ...
  <div class="admin-login-card">
    <div class="admin-login-marca">
      <span class="logo-icon">
        <img src="../assets/img/mascote-white.png" width="26" height="26" alt="" style="display:block;" />
      </span>
    ...
    <form method="post" action="login.php">
      <div class="campo">
        ...
        <div class="campo-entrada">
          ...
          <input type="email" name="email" value="<?= htmlspecialchars($_POST['email'] ?? '') ?>" placeholder="admin@exemplo.com" required />
        </div>
      </div>
      <div class="campo">
