...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $eh_ajax = strtolower($_SERVER['HTTP_X_REQUESTED_WITH'] ?? '') === 'xmlhttprequest';
    ...
    if ($nome === '' || $email === '') {
        ...
        if ($eh_ajax) {
            ...
            echo json_encode(['ok' => true, 'data' => ['redirect' => 'pago']]);
            exit;
        }
...
<div class="vista-mobile">
  ...
  <div class="conteudo-pagina">
    ...
    <form method="post" action="cadastro" class="form-cadastro">
      <p class="dica dica-erro" style="color:var(--red);<?= $erro ? '' : 'display:none;' ?>"><?= htmlspecialchars($erro) ?></p>
      <div class="campo">
...
<div class="vista-desktop">
  <div class="cadastro-estrutura">
    ...
    <div class="cadastro-form">
      <form class="form-area form-cadastro" method="post" action="cadastro">
